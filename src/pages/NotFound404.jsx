...
export const NotFound404 = () => {
    ...
    const changeToLanguaje = () => { setIsEnglish(!isEnglish) }
...
<div className="notfound">
    ...
    <svg aria-labelledby="404" alt="404 Pagina no encontrada" class="not-found">
    ...
    <h1>{isEnglish ? "Page not found":"Pagina no encontrada"}</h1>
        
        <button className="notFountBtn" onClick={changeToLanguaje}> {isEnglish ? "Change to languaje":"Cambiar de idioma"} </button>
        <p> <Link to='/'> {isEnglish ? "Home":"Pagina principal"} </Link></p>
        <p> <Link to='/Eventos'> {isEnglish ? "Events":"Eventos"} </Link></p>
        <p> <Link to='/Areas'> {isEnglish ? "Areas":"Areas"} </Link></p>
        <p> <Link to='/Atracciones'> {isEnglish ? "Attractions":"Atracciones"} </Link></p>
        <p> <Link onClick={handleGoback}> {isEnglish ? "Go to back page":"Volver a la pagina anterior"} </Link></p>
    </div>
